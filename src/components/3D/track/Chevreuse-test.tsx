...
export function Chevreuse(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(
    "/models/tracks/chevreuse-test.glb"
  ) as GLTFResult;
  return (
    <group {...props} dispose={null} scale={16} position={[0, 0, -145]}>
      <mesh
        castShadow
        receiveShadow
      ...
      >
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard001.geometry}
          material={materials["bark.001"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard001_1.geometry}
          material={materials.bark}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard001_2.geometry}
          material={materials.tankco}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard001_3.geometry}
          material={materials["tankco.001"]}
        />
      </group>
      <group
        position={[-5.053, -0.505, 26.873]}
      ...
      >
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard003.geometry}
          material={materials["bark.001"]}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard003_1.geometry}
          material={materials.bark}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard003_2.geometry}
          material={materials.tankco}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Mesh_billboard003_3.geometry}
          material={materials["tankco.001"]}
        />
      </group>
      <mesh
      ...
      <mesh
        ...
        position={[-0.289, -5.985, 2.8]}
      />
      <RigidBody type="fixed" colliders="trimesh" friction={1}>
      <mesh castShadow receiveShadow geometry={nodes.road.geometry} position={[-33, 0, 89]} />
      </RigidBody>
    </group>
  );
}

useGLTF.preload("/models/tracks/chevreuse-test.glb");
